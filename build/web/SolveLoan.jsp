...
<html>
    ...
    <center>
        ...
        <br>
        <br>
                <form action="SolveLoanFinished.jsp">
            <input type="submit" name="next" value="一键审批" style= "background-color: transparent;font-size:16px;height:50px;width:200px "/>
        </form>
                <br><br>
